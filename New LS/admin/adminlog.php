...
<body style="background-image: url('img/Amaze.jpg'); background-size: cover; background-repeat: no-repeat; background-position: center; background-attachment: fixed;">
  <div class="container">
    <div class="login-form">
      <h1><strong>Log into Library Management System Admin </strong></h1>
      <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
        ...
        <p>Don't have an account? <a href="adminRegisterform.php"><button type="button" class="register-btn">Click here to Register</button></a></p>
      </form>
    </div>
  </div>
